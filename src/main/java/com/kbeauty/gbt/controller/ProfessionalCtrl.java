...
@RequestMapping("/w1/pro")
@Controller
@Slf4j
public class ProfessionalCtrl {
...
//	}	
	...
	public String save(Lesson lesson, @RequestParam("mainUploadFile") MultipartFile mainFile) throws Exception{
