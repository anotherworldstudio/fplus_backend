...
public abstract class Condition {
	...
	protected String delYn;     // 삭제 여부 필드 
	protected int page;  		// 보여줄 페이지 번호
	protected int perPageNum;   // 페이지당 보여줄 게시글의 개수
	...
	protected Condition(int page, int perPageNum) {
		//최초 게시판에 진입할 때를 위해서 기본 값을 설정 해야 한다.
		this.page = page;
	...
	protected void setPerPageNum(int perPageNum) {
